  ...
  return (
    <div className={styled['pagination']}>
      <div className={styled['pagination__content']}>
        <SlArrowLeft
          className={`${styled['pagination__prev']} ${
            currentPage === 1 ? styled['pagination__prev-grey'] : ''
          }`}
          onClick={prePage}
        />
        {pageNumbers.map((data) => (
          <span
            ...
            className={`${styled['pagination__number']} ${
              data === currentPage ? styled['pagination__number-active'] : ''
            }`}
        ...
        <SlArrowRight
          className={`${styled['pagination__next']} ${
            currentPage === endPage ? styled['pagination__prev-grey'] : ''
          }`}
          onClick={nextPage}
        />
      </div>
